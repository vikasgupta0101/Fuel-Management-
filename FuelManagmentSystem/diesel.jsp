...
<body style="background-image: url('./image/diesel.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover">
      ...
      <c:if test="${not empty errorMsg}">
       ...
       <div class="dropdown">
         ...
         <tr>
            ...
            <td><input type="text" name="purate" value="<%=scou.getAvgDiesel()%>" readonly></td>
         </tr> 
         
         <tr>
           <td>Fuel Type: </td>
           <td><input type="text" value="Diesel" readonly name="fueltype" required readonly></td>
         </tr> 
         ...
         <tr>
           <td>Total Stock: </td>
           <td><input type="text" placeholder="" name="totalStock" value="<%=diesel%>" required readonly class="ts"></td>
         </tr> 
