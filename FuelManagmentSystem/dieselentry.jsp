    ...
    <section>
      <form action="Enterthestock" method="post">
		...
		<div class="dropdown">
		  ...
		  <tr>
		  <td>FuelType: </td>
		  <td><input type="text" value= "Diesel" name="fueltype" readonly  required></td>
		  </tr>
		  
		  <tr>
		  <td>Opening Stock: </td>
		  <td><input type="text" placeholder="opening stock" name="openingstock" required value="<%=diesel%>" readonly></td>
		  </tr>
		  ...
		  <tr>
		  <td>Total Stock: </td>
		  <td><input type="text" placeholder="Total Stock" name="totalstock" value="<%=diesel%>" readonly></td>
		  </tr>
