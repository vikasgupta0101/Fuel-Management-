      ...
      <form action="Enterthestock" method="post">
		<table>
		 <div class="dropdown">
		  ...
		  <tr>
		  <td>FuelType: </td>
		  <td><input type="text" value= "Mobil" name="fueltype" readonly required></td>
		  </tr>
		  
		  <tr>
		  <td>Opening Stock: </td>
		  <td><input type="text" placeholder="opening stock" name="openingstock" required value="<%=mobil%>" readonly></td>
		  </tr>
		  ...
		  <tr>
		  <td>Total Stock: </td>
		  <td><input type="text" placeholder="Total Stock" name="totalstock" value="<%=mobil%>" readonly></td>
		  </tr>
