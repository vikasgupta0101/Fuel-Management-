...
<body style="background-image: url('./image/carbattery.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover">
      ...
      <c:if test="${not empty errorMsg}">
       ...
       <table>
         ...
         <tr>
            ...
            <td><input type="text" name="purate" value="<%=scou.getAvgPower()%>" readonly></td>
         </tr>
         
         <tr>
           <td>Fuel Type: </td>
           <td><input type="text" value="Power" readonly name="fueltype" required readonly></td>
         </tr> 
         
         <tr>
           <td>Sell Quantity: </td>
           <td> <input class="sq" type="text" placeholder="Sell quantity" name="sellqty" required class="sq"></td>
         </tr> 
         ...
         <tr>
           <td>Total Stock: </td>
           <td><input class="ttls" type="text" placeholder="" name="totalStock" value="<%=power%>" required readonly class="ts"></td>
         </tr> 
